...
/* Set journey */
router.post('/migration-2/prototype-set-up', function (req, res) {
...
router.post('/migration-2/start-page', function (req, res) {
...
/* Start page for sign in */
router.post('/migration-2/sign-in-webfiling-interupt', function (req, res) {
...
router.post('/migration-2/sign-in-webfiling-interupt-simplified', function (req, res) {

    res.redirect('account-support')
})

/* Start page for sign in screen flow */
router.post('/migration-2/account-support', function (req, res) {
...
/* Start page for sign in screen flow */
router.post('/migration-2/account-support-1', function (req, res) {

    res.redirect('one-login/create-or-sign-in')
})

/* Start page for sign in screen flow */
router.post('/migration-2/account-support-2', function (req, res) {
...
/* GOV.UK One login */
router.post('/migration-2/one-login/one-login-sign-in', function (req, res) {
...
router.post('/migration-2/one-login/enter-code', function (req, res) {
...
router.post('/migration-2/one-login/create-enter-email', function (req, res) {
...
/* Create a GOV.UK One login */
router.post('/migration-2/one-login/create-check-your-email', function (req, res) {

    res.redirect('create-enter-password')
  })

/* Create a GOV.UK One login */
router.post('/migration-2/one-login/create-enter-password', function (req, res) {
  ...
  //Create a GOV.UK One login
  router.post('/migration-2/one-login/create-choose-security-type', function (req, res) {
 ...
 /* Create a GOV.UK One login */
router.post('/migration-2/one-login/create-set-up-auth-app', function (req, res) {

    res.redirect('create-complete')
})

 /* Create a GOV.UK One login */
 router.post('/migration-2/one-login/create-enter-mobile-number', function (req, res) {

    res.redirect('create-complete')
})

 /* Create a GOV.UK One login */
 router.post('/migration-2/one-login/create-complete', function (req, res) {
...
/* CHS interupt */
router.post('/migration-2/chs-interrupt', function (req, res) {
...
router.post('/migration-2/chs-interrupt-no-account-found', function (req, res) {
...
/* Webfiling interupt */
router.post('/migration-2/webfiling-interrupt', function (req, res) {
...
/* Webfiling interupt */
router.post('/migration-2/verify-email-address', function (req, res) {
...
router.post('/migration-2/end-linking', function (req, res) {
...
router.post('/migration-2/link-to-existing-chs-account', function (req, res) {
...
/* Linking CHS accounts */
router.post('/migration-2/chs-account-linked', function (req, res) {
...
/* Linking CHS accounts */
router.post('/migration-2/no-chs-found-interrupt', function (req, res) {
...
router.post('/migration-2/no-webfiling-found', function (req, res) {
...
router.post('/migration-2/no-webfiling-found-change-email', function (req, res) {
...
/*  Changing WebFiling email address  */
router.post('/migration-2/webfiling-email-address', function (req, res) {
...
/* Changing WebFiling email address */
router.get('/migration-2/webfiling-email-address-return-to-sign-in', function (req, res) {
...
router.post('/migration-2/webfiling-password', function (req, res) {
...
/*  WebFiling change email address to same as One Login */
router.post('/migration-2/webfiling-new-email-address', function (req, res) {
...
/*  WebFiling change email address to same as One Login */
router.post('/migration-2/webfiling-email-changed', function (req, res) {
